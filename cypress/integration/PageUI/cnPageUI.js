class CreditNotePageLocator{
    constructor() {
        ...
        this.ap_approval_route_dropdown_css = " [name='approvalRouteName']";
        ...
        this.filter_item_quantity_in_table_css = "[aria-label='Quantity Filter Input']";
        ...
        // Xpath - Validation
        this.validation_text_supplier_xpath = "//*[@name='supplierCode']/parent::*/following-sibling::*[@class='invalid-feedback']";
        this.validation_text_buyer_code_xpath = "//label[text()='Buyer Code']/parent::*/parent::*//*[@class='invalid-feedback']";
        this.validation_text_reference_invoice_xpath ="//*[@name='invoiceUuid']/following-sibling::*[@class='invalid-feedback']";
        this.validation_text_credit_note_number_xpath = "//*[@name='creditNoteNumber']/following-sibling::*[@class='invalid-feedback']";
    }
