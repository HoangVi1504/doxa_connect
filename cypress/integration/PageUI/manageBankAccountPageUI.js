class ManageBankAccountPageLocator{
    constructor(){
        // Css - Txb
        ...
        this.approver_bank_account_in_list_css = ".ag-row-first>[col-id='approverName']";
        this.requester_bank_account_in_list_css = ".ag-row-first>[col-id='requestorName']";
        ...
        this.add_bank_account_page_title_xpath = "//h1//*[text()='Add New Bank Account']";
        this.bank_account_list_page_title_xpath = "//h1//*[text()='List of Bank Account']";
        this.bank_account_details_page_title_xpath = "//h1//*[text()='Bank Account Details']";
...
}export default ManageBankAccountPageLocator