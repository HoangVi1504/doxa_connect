@pr @p2p
Feature: 0133 Raise PR with Project, add manual item and 1 approver

Scenario: P2P-PR-S02-001 Raise PR with Project, add manual item and 1 approver
    ...
    When I add manual item from "pr_v3" json file at Raise PR page
    ...
    When I input PR title from "pr_v3" json file to 'Search PR' textbox
