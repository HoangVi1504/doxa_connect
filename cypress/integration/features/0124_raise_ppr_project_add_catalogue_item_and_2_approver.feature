@ppr @p2p
Feature: 0124 Raise PPR with Project, add catalogue item and 2 approver
...
Scenario: P2P-PPR-S02-002 Raise PPR with Project, add catalogue item and 2 approver
    ...
    When I add catalogue item from "ppr_v4" json file at Raise PPR page
    ...
    When I input PPR title from "ppr_v4" json file to 'Search PPR' textbox
...
Scenario: P2P-PPR-S07-001 Approver approval PPR
    ...
    When I double click to PPR title in PPR list from "ppr_v4" json file
