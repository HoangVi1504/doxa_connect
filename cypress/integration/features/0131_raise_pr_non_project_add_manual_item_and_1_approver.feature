@pr @p2p
Feature: 0131 Raise PR with Non-project, add manual item and 1 approver
...
Scenario: P2P-PR-S01-001 Raise PR with Non-project, add manual item and 1 approver
    ...
    And I see Requester name in PR list from "pr_v1" json file
    And I see Procurement type in PR list from "pr_v1" json file
    And I see Approval Route in PR list from "pr_v1" json file
