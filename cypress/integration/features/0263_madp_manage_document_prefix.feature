...
Scenario: MADP-002 Update prefixes for an entity (Contract, RFQ Pricing, Purchase Order)
    ...
    And I input "123" to 'Prefix' textbox at 'Document Prefix Details' page
    ...
    And I see creator of function just searched in 'Document Prefix' list is "AUTO ENTITY DX"
