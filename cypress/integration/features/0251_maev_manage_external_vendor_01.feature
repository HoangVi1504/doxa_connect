...
Feature: 0251 Entity admin can create and update external vendror with role buyer

Scenario: MAEV-001-003 Entity admin can create external vendor
    ...
    And I select "Bank Account Default (150497)" from 'Bank Account' dropdown at 'Create External Vendor' page
    ...
    And I click to "Add" button format_2
    And I input random full name to 'Full Name' in 'Contact' list at 'Create External Vendor' page
    And I select 'Singapore' from 'Country Code' in 'Contact' list at 'Create External Vendor' page
    And I input random contact number to 'Contact Number' in 'Contact' list at 'Create External Vendor' page
    And I input random email address to 'Email Address' in 'Contact' list at 'Create External Vendor' page
    ...
    And I see tax registered company status in 'Manage External Vendor' list is "No"
...
Scenario: MAEV-005-003 Entity admin can update the existing buyer
    Given Navigate to Doxa Connect 2.0 site
    When I login with role "buyer"
    And I click to 'User Profile' button
    And I click to "Admin" button format_1
