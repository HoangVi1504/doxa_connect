...
Feature: 0236 Entity admin can create, update and delete contracted catalogue item

Scenario: MACA-002 Entity admin can create contracted catalogue item
    ...
    Then I see a validation text of 'Contract Reference No' at 'Create Catalogue Item' page appears "Please enter valid Contract Reference No."
    And I see a validation text of 'Item Code' at 'Create Catalogue Item' page appears "Please enter valid Item Code"
    ...
    And I see a validation text of 'Valid From' at 'Create Catalogue Item' page appears "Valid From is required"
    And I see a validation text of 'Valid To' at 'Create Catalogue Item' page appears "Valid To is required"
    And I see a validation text of 'Contracted Price' at 'Create Catalogue Item' page appears "Please enter valid Contracted Price"

    When I input random contract reference to 'Contract Reference No' textbox at 'Create Catalogue' page
    And I input "auto item code 1" to 'Item Code' textbox at 'Create Catalogue Item' page
    ...
    And I input random item code to 'Item Code' textbox at 'Create Catalogue Item' page
    ...
    And I see contracted status of catalogue just created in 'Catalogue' list is "Yes"
...
Scenario: MACA-004 Entity admin can update and delete non contracted catalogue
    Given Navigate to Doxa Connect 2.0 site
    When I login with role "buyer"
    And I click to 'User Profile' button
    And I click to "Admin" button format_1
    ...
    And I see item code of catalogue just created in 'Item Code' textbox at 'Catalogue Details' page
    ...
    And I input "4" to 'Contracted Quantity' textbox at 'Create Catalogue' page
    And I input "2000000" to 'Contracted Price' textbox at 'Create Catalogue' page
    ...
    And I see contracted quantity in 'Contracted Quantity' textbox at 'Catalogue Details' page is "4"
    And I see contracted price in 'Contracted Price' textbox at 'Catalogue Details' page is "2000000"
    ...
    And I see contracted status of catalogue just created in 'Catalogue' list is "Yes"
    And I see random contracted reference number of catalogue just created in 'Catalogue' list
    And I see contracted quantity of catalogue just created in 'Catalogue' list is "4"
    And I see unit price of catalogue just created in 'Catalogue' list is "10000"
    And I see contracted price of catalogue just created in 'Catalogue' list is "2000000"
    And I see active status of catalogue just created in 'Catalogue' list is "No"
    And I see action of catalogue just created in 'Catalogue' list is "Activate"

    When I click to action "Activate" of catalogue just created in 'Catalogue' list
    ...
    When I click to "I Understand" button format_1
    And I input item code of catalogue just created to 'Filter Item Code' in 'Catalogue' list
    And I see random item code of catalogue just created in 'Catalogue' list
    And I see active status of catalogue just created in 'Catalogue' list is "Yes"
    And I see action of catalogue just created in 'Catalogue' list is "Deactivate"

    When I click to action "Deactivate" of catalogue just created in 'Catalogue' list
    Then I see a notification appears "Are you sure you want to deactivate these catalogue items?"
