@inv @p2p
Feature: 0163a Creator create invoice with tax adjustment

Scenario: Buyer set 'Invoice' Document Prefix as Manual
    ...
    When I select "Manual Key In" from 'Pre-fix Status' dropdown at 'Document Prefix Details' page
    ...
    And I input "Invoice" to 'Filter Function' in 'Document Prefix' list
    Then I see function just searched in 'Document Prefix' list is "Invoice"
    And I see type of function just searched in 'Document Prefix' list is "Manual"
